      ...
      >
        <div className="flex items-center gap-3 p-4">
          <div className="relative">
            <div className="w-10 h-10 bg-gradient-to-br from-purple-600 via-purple-500 to-blue-600 rounded-xl flex items-center justify-center shadow-lg ring-2 ring-purple-200/50 dark:ring-purple-800/30">
          ...
          {!isCollapsed && (
            <div className="flex-1 min-w-0">
              <h1 className="font-bold text-lg bg-gradient-to-r from-purple-700 via-purple-600 to-blue-600 bg-clip-text text-transparent tracking-tight">
                AI Influence
              </h1>
            </div>
          )}
